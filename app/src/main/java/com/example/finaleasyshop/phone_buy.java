...
public class phone_buy extends Fragment {
    ImageView pImage;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_phone_buy, container, false);
        name = (TextView) v.findViewById(R.id.brand_name);
        price = (TextView) v.findViewById(R.id.price);
        brand1= (TextView) v.findViewById(R.id.brandNAME);
        ...
        if (bundle != null) {
            ...
            String pbrand = bundle.getString("brand");
    ...
    private void deleteProduct(){
        Phone_Upload selectedItem = mUploads3.get(position);
