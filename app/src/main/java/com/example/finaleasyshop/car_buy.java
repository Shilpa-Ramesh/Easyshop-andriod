...
public class car_buy extends Fragment {
    ImageView pImage;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_car_buy, container, false);
        ...
        if (bundle != null) {
            ...
            String pyear = bundle.getString("year");
    ...
    private void deleteProduct(){
        Car_Upload selectedItem = mUploads1.get(position);
