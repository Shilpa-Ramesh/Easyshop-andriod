...
public class sell_book extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_sell_book, container, false);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("book_upload");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("book_upload");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            taskSnapshot.getMetadata().getReference().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    Book_Upload upload = new Book_Upload(mEditTextFileName.getText().toString().trim(),
