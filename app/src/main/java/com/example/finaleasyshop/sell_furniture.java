...
public class sell_furniture extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_sell_furniture, container, false);
        ...
        mEditTextsize = v.findViewById(R.id.size);
        mEditTextFilePrice=v.findViewById(R.id.price);
        mImageView = v.findViewById(R.id.image_view);
        mProgressBar = v.findViewById(R.id.progress_bar);
        mDescription = v.findViewById(R.id.description);
        mStorageRef = FirebaseStorage.getInstance().getReference("furniture_uploads");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            taskSnapshot.getMetadata().getReference().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    Furniture_Upload upload = new Furniture_Upload(mEditTextFileName.getText().toString().trim(),
                                            uri.toString(), mEditTextFilePrice.getText().toString().trim(),
                                            mEditTextsize.getText().toString().trim(),
