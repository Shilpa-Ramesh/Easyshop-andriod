...
public class sell_phones extends Fragment {
    ...
    private EditText mEditTextaname;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_sell_phones, container, false);

        mButtonChooseImage = v.findViewById(R.id.button_choose_image);
        mButtonUpload = v.findViewById(R.id.button_upload);
        mEditTextFileName = v.findViewById(R.id.product_name);
        mEditTextFilePrice = v.findViewById(R.id.price);
        //mEditTextbname = v.findViewById(R.id.company_name);
        mEditTextaname = v.findViewById(R.id.company_name);
        mImageView = v.findViewById(R.id.image_view);
        mProgressBar = v.findViewById(R.id.progress_bar);
        mDescription = v.findViewById(R.id.description);
        mStorageRef = FirebaseStorage.getInstance().getReference("phone_upload");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            taskSnapshot.getMetadata().getReference().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    Phone_Upload upload = new Phone_Upload(mEditTextFileName.getText().toString().trim(),
                                            uri.toString(), mEditTextFilePrice.getText().toString().trim(),
                                            mEditTextaname.getText().toString().trim(),
                                            mDescription.getText().toString().trim());
                                    String uploadId = mDatabaseRef.push().getKey();
                                    mDatabaseRef.child(uploadId).setValue(upload);
                                    mEditTextFileName.setText("");
                                    mEditTextFilePrice.setText("");
                                    mEditTextaname.setText("");
